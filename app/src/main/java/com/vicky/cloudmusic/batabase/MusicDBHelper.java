...
public class MusicDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE music (mId INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT,cloud_type int,realId TEXT,artist TEXT,album TEXT,picture TEXT,path TEXT,lyr TEXT);");
    }
    ...
    public Cursor getAll(String where, String orderBy) {//返回表中的数据,where是调用时候传进来的搜索内容,orderby是设置中传进来的列表排序类型
        StringBuilder buf=new StringBuilder("SELECT mId, name, cloud_type, realId,artist,album, picture, path,lyr FROM music");
    ...
    public void insert(String name, int cloud_type, String realId,String artist,String album, String picture, String path,String lyr) {
    ...
    public void update(String mId, String name, int cloud_type, String realId, String artist,String album,  String picture, String path,String lyr) {
        ContentValues cv = new ContentValues();
        String[] args= { mId };
